...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row visible">
        ...
        <div class="row visible">
		<?php echo CHtml::activeLabelEx($model,'user_visible'); ?>
		<?php echo CHtml::activeDropDownList($model,'user_visible',ProfileField::itemAlias('user_visible')); ?>
		<?php echo CHtml::error($model,'user_visible'); ?>
	</div>
